    ...
    >
      ...
      >
        <img
          ...
          className="w-[320px] md:w-[480px] lg:w-[560px] h-auto object-contain className="w-[320px] md:w-[480px] lg:w-[560px] h-auto object-contain className="w-[320px] md:w-[480px] lg:w-[560px] h-auto object-contain drop-shadow-[0_30px_60px_hsl(0_100%_40%_/_0.3)]"""
        />
